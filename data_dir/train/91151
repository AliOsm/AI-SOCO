...
/***********************************************
** File name: 57A.cpp                         **
** Time created: Sun Feb 17 2019 07:26am      **
***********************************************/
...
void Solve() {
	if (y1 == y2 && (y1 == 0 || y1 == n)) {cout << abs(x1 - x2) << endl; return;}
	if (x1 == x2 && (x1 == 0 || x1 == n)) {cout << abs(y1 - y2) << endl; return;}
	if ((y1 == 0 && y2 == n) || (y1 == n && y2 == 0)) {cout << min(x1+x2+n, n*3-x1-x2) << endl; return;}
	if ((x1 == 0 && x2 == n) || (x1 == n && x2 == 0)) {cout << min(y1+y2+n, n*3-y1-y2) << endl; return;}
